...
namespace Tarenka
{
    public partial class Form2 : Form
    {
        ...
        public void DateNew()
        {
            ...
            string sql = $"select Orders.Id as id, Client.Id as clientid, Services.Id as servicesid, ContractId as contractid, StaffId as staffid, concat(Client.SecondName,' ',Client.Name,' ',Client.MiddleName) as Клиенты, Name_Services as Услуга, concat(staff.secodname,' ',staff.name,' ',staff.middlename) as Инженера, ContractStart as Начало, " +
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            selectGrid5 = dataGridView1.SelectedRows[0].Cells["Инженера"].Value.ToString();
